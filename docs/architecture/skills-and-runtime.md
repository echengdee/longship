...
The current Voice Tour V0 has a provider-neutral navigation seam under
`src/longship/navigation/`. It can evolve toward this layout without changing
the semantic meaning of `navigate_to` or exposing Nav2 and target details to
the tour mission.
